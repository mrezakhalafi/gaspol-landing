...
==================================== -->
  ...
  <div class="hero-slider">
    <div class="slider-item th-fullpage hero-area" style="background-image: url(assets/img/Collage.png);">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <a id="join-club-1" data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".8" class="btn btn-main" href="membership.php">Pembuatan KTA, KIS, TKT, TAA</a>
            <!-- <a id="join-club-3" data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".8" class="btn btn-main" href="http://108.136.138.242/gaspol_web/pages/menu_membership">Pembuatan KTA, KIS, TKT, TAA</a> -->
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <a id="join-club-2" data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".8" class="btn btn-main" href="membership.php">Pembuatan KTA, KIS, TKT, TAA</a>
            <!-- <a id="join-club-4" data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".8"  class="btn btn-main" href="http://108.136.138.242/gaspol_web/pages/menu_membership">Pembuatan KTA, KIS, TKT, TAA</a> -->
          </div>
        </div>
      </div>
    </div>
  ...
  <div style="background-color: #F6F6F6" class="p-5">
    <div class="row">
      <div class="col-12 text-center">
        ...
        <img src="assets/img/represented.svg" style="width: 180px;">
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6">
          <div class="text-center mt-3" style="background-color: #F6F6F6; border-radius: 20px; height: 200px">
            <img src="assets/img/association-orange.svg" style="width: 150px">
            <p><b>Akses tak terbatas ke jaringan IMI</b></p>
          </div>
        </div>
        <div class="col-12 col-md-6">
          <div class="text-center mt-3" style="background-color: #F6F6F6; border-radius: 20px; height: 200px">
            <img src="assets/img/events-orange.svg" style="width: 150px">
            <p><b>Akses tak terbatas ke acara nasional</b></p>
          </div>
        </div>
        <div class="col-12 col-md-6">
          <div class="text-center mt-3" style="background-color: #F6F6F6; border-radius: 20px; height: 200px">
            <img src="assets/img/product.svg" style="width: 150px">
            <p><b>Diskon produk dari toko</b></p>
          </div>
        </div>
        <div class="col-12 col-md-6">
          <div class="text-center mt-3" style="background-color: #F6F6F6; border-radius: 20px; height: 200px">
            <img src="assets/img/safe.svg" style="width: 150px">
          ...
          <article class="col-md-4 col-sm-6 col-xs-12 clearfix ">
            <div class="post-item">
              <div class="media-wrapper text-center">
                <img src="<?= $n['IMAGES'] ?>" alt="amazing caves coverimage" style="border-radius: 20px" class="img-fluid">
              </div>

              <div class="content text-center">
                <h3 style="font-size: 20px"><a href="article.php"><?= $n['TITLE'] ?></a></h3>
                <p><?= substr_replace($n['NEWS'], "...", 120);  ?></p>
                <a class="btn btn-main" href="article.php?id=<?= $n['ID'] ?>">Read more</a>
              </div>
            </div>
          </article>
