...
$sqlData = "SELECT kta.*, TKT.CLUB_NAME, REGISTRATION_PAYMENT.DATE
  FROM KTA kta LEFT JOIN REGISTRATION_PAYMENT ON kta.F_PIN = REGISTRATION_PAYMENT.F_PIN LEFT JOIN TKT ON TKT.ID = kta.CLUB_CHOICE WHERE kta.F_PIN = '$f_pin' ORDER BY kta.ID DESC LIMIT 1";
...
<body>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 justify-content-center" style="position: absolute; margin-left: -234px; margin-top: 155px">
                                    <div class="row gx-0">
                                        ...
                                        <div class="col-12" style="margin-top: 53px; position: absolute">
                                            <p class="data-person">
                                                <?php
                                                    // $club
                                                ?>
                                    ...
                                    <div class="row gx-0" style="margin-top: -17px">
                                        <div class="col-12" style="position: absolute; margin-top: 70px">
                                            <p class="data-person">
                                ...
                                <div class="col-3 d-flex justify-content-center" style="position: absolute; margin-top: 165px; margin-left: -80px; width: 100px; height: 77px">
                                    ...
                                    <img id='barcode' onclick="modalQR()" src="https://api.qrserver.com/v1/create-qr-code/?data=<?= strtoupper($unique_number) ?>&amp;size=100x100" alt="" width="120" height="120" style="color: green; z-index: 999">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-12 d-flex justify-content-center">
            <div class="row gx-0 p-3 x-3" style="width: 350px">
                <div class="col-12 d-flex justify-content-center" style="height: 250px; width: 350px; border-radius: 10px; background-color: transparent; margin-top: -33px">
                    <div class="row gx-0">
                        <div class="spinner-border" role="status" style="margin-top: 65px; margin-left: 24px; position: absolute; width: 120px; height: 120px">
                            <span class="visually-hidden">Loading...</span>
                        </div>
                        ...
                        <div class="col-6 d-flex justify-content-center" style="margin-left: 172px; margin-top: 45px">
                            <div class="row gx-0">
                                <div class="col-12 d-flex justify-content-center">
                                    <button class="btn btn-warning" onclick="htmlToPrint()" style="width: 125px; height: 40px; border-radius: 30px; color: white; background-color: #f66701 !important">Print Card</button>
                                </div>
