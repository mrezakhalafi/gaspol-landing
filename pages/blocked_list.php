...
<body class="bg-white-background" style="display:none">
  ...
  <nav class="navbar navbar-light bg-purple" style="background-color: #f66701">
    <div class="container">
      ...
      <p class="navbar-title">Blocked List User</p>
  ...
  <div class="section-recent-activities">
    <div class="container recent-activities-title">
      <p class="text-purple small-text">Recent Blocked User</p>
    </div>
    <div class="container">
        ...
        <?php foreach($user_blocked as $block): ?>
          ...
          <div class="row small-text one-followers">
            ...
            <div class="col-3 col-md-3 col-lg-3">
              ...
              <button class="btn-follow" onclick="openModal1('<?= $block['FIRST_NAME'] ?>','<?= $block['L_PIN'] ?>')" type="button" style="padding-left:5px; padding-right:5px; border: 1px solid #f66701; color: #f66701" data-toggle="modal" data-target="#unfollowModal1">Unblock</button>
            </div>
          </div>
      ...
      <?php else: ?>
        ...
        <p class="text-center small-text mt-5 no-blocked">You havent blocked anyone yet.</p>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content" style="height:100%">
        <div class="modal-body">
          <span style="font-size: 14px" class="are-u-sure">Are you sure to unblock </span><span style="font-size: 14px" id="text-shop-name1"></span><span style="font-size: 14px">?</span>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" onclick="closeModal()" style="font-size: 14px; color: #000000; border: 1px solid #f66701; background-color: #FFFFFF" data-dismiss="modal">No</button>
          <form action="../logics/unblock_user_list" method="POST">
            <input type="hidden" name="f_pin" value="<?= $id_user ?>">
            <input type="hidden" name="shop_id" id="shop_id" value="">
            <button type="submit" class="btn btn-yes" style="font-size: 14px; color: #FFFFFF; background-color: #f66701">Yes</button>
          </form>
        </div>
      </div>
    </div>
