        ...
        <form method="POST" class="main-form" id="taa-form" enctype="multipart/form-data" style="padding: 0px">
            <div class="row gx-0 p-2" style="border-bottom: 2px #e5e5e5 solid; background-image: url(../assets/img/lbackground_2.png)">
                ...
                <div class="col-11 d-flex justify-content-center">
                    <h2 style="margin-bottom: 0px">TAA Club Registration</h2>
                </div>
            </div>
            ...
            <div class="container mx-auto pt-4">
                <h2 class="text-center"><span style="font-size: 22px">Association <span style="color: #f66701">Information</span></span><br><span style="font-size: 16px; color: #626262">(Tanda Anggota Asosiasi)</span></h2>
            </div>
            ...
            <div class="container mx-auto mt-3">
                ...
                <div class="collapse show mt-2" id="collapseIdentification">
                    ...
                    <span class="adart text-danger" style="position: absolute; margin-top: -33px; margin-left: -96px; z-index: 999">*</span>
                ...
                <div class="collapse show mt-2" id="collapseCL">
                    <!-- 1st Choice -->
                    <select class="mt-3 mb-2" style="margin-left: -5px" id="club-category" name="club-category" aria-label="" style="font-size: 16px" >
                    ...
                    <!-- 2nd Choice -->
                    <select class="mt-3 mb-2" style="margin-left: -5px" id="club-category-2" name="club-category-2" aria-label="" style="font-size: 16px" >
                    ...
                    <!-- 3rd Choice -->
                    <select class="mt-3 mb-2" style="margin-left: -5px" id="club-category-3" name="club-category-3" aria-label="" style="font-size: 16px" >
                    ...
                    <!-- 4th Choice -->
                    <select class="mt-3 mb-2" style="margin-left: -5px" id="club-category-4" name="club-category-4" aria-label="" style="font-size: 16px" >
                    ...
                    <!-- 5th Choice -->
                    <select class="mt-3 mb-2" style="margin-left: -5px" id="club-category-5" name="club-category-5" aria-label="" style="font-size: 16px" >
