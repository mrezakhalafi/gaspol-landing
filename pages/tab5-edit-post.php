                    ...
                    <div class="image-upload">
                      <label for="file-input-<?= $i ?>" class="row" style="--bs-gutter-x: none">
                        ...
                        <?php if (substr($product_image[$i], -3) == "mp4") : ?>
                          <video src="../images/<?= $product_image[$i] ?>#t=0.5" loop autoplay muted id="image-preview-<?= $i ?>" class="upload-listing-border filled" style="object-fit: none">
                          <?php else : ?>
                            <img src="../images/<?= $product_image[$i] ?>" id="image-preview-<?= $i ?>" class="upload-listing-border filled">
                          <?php endif; ?>
...
<script>
  ...
  function checkValid() {
    ...
    let postImageValid = $('.upload-listing-border.filled').length > 0;
    ...
    if (isTitleValid && postImageValid) {
      console.log('enabled');
  ...
  function setImage(link, number, thumbnail = "") {
    ...
    if (strings[0] == 'data:video') {
      $('#image-preview-' + number).replaceWith('<video src="' + link + '#t=0.5" id="video-preview-' + number + '" style="object-fit: none" type="video/mp4" class="upload-listing-border filled">');

      // IF DIV ALREADY VIDEO REPLACE AGAIN (IMG CANNOT BE FOUND)

      $('#video-preview-' + number).replaceWith('<video src="' + link + '#t=0.5" id="video-preview-' + number + '" style="object-fit: none" type="video/mp4" class="upload-listing-border filled">');
