...
<body>
  ...
  <div class="section-post-description mt-3">
    <div class="row gx-0 add-post">
      <input type="text" class="add-post-input" id="post_title" maxlength="64" name="post_title" placeholder="">
      <div class="d-flex justify-content-end">
        <span id="counter-word-2" class="smallest-text text-grey">0</span><span class="smallest-text text-grey">/64</span>
      </div>
    </div>
    <div class="row gx-0 add-post">
      <textarea class="add-post-input" id="caption" maxlength="512" required rows="10" name="caption" placeholder=""></textarea>
      <div class="d-flex justify-content-end">
    ...
    <div class="row gx-0 add-post mt-2" style="padding-bottom: 0px">
      <div class="dropdown" style="margin-top:-7px; margin-bottom: 5px;">
        <button class="dropdown-toggle text-grey" style="margin-top: 10px; margin-bottom: -10px; border: 1px solid lightgrey !important; padding: 10px; border-radius: 20px" type="button" id="upload-listing-dropdown" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuSelectCategory">
          ...
          <input type="hidden" id="category" class="category" name="category" value="404">
          <input type="hidden" id="category_name" class="category_name" name="category_name" value="Others">
        </ul>
      </div>
    </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    if (localStorage.lang == 1) {
      ...
      $('#caption').attr('placeholder', 'Write a Description');
    }
