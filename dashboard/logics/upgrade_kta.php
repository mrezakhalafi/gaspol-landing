...
if ($status_anggota == 0){
        ...
        if ($start_upload){
            ...
            if ($f_pin != "") {
                $queryPost = "INSERT INTO KTA (F_PIN, NAME, EMAIL, BIRTHPLACE, DATEBIRTH, GENDER, BLOODTYPE, NATIONALITY, HOBBY, ADDRESS, RTRW,
                                PROVINCE, CITY, DISTRICT, DISTRICT_WORD, POSTCODE, EKTP, PROFILE_IMAGE, EKTP_IMAGE, STATUS_ANGGOTA, NO_ANGGOTA, CLUB_TYPE, CLUB_LOCATION, CLUB_CHOICE, HOBBY_DESC, IS_ANDROID) VALUES ('".$f_pin."','".$name."',
                                '".$email."','".$birthplace."','".$date_birth."','".$gender_radio."','".$bloodtype."','".$nationality."','".$hobby."','".$address."','".$rt. "/" .$rw."','".$province."',
                                '".$city."','".$district."','".$district_word."','".$postcode."','".$ektp."','".$pasFoto."','".$fotoEktp."','1','".$id_anggota."','".$club_type."','".$club_location."','".$club_choice_new."','".$hobby_desc."',".$is_android.")";
            }

            else {
                $queryPost = "INSERT INTO KTA (NAME, EMAIL, BIRTHPLACE, DATEBIRTH, GENDER, BLOODTYPE, NATIONALITY, HOBBY, ADDRESS, RTRW,
                                PROVINCE, CITY, DISTRICT, DISTRICT_WORD, POSTCODE, EKTP, PROFILE_IMAGE, EKTP_IMAGE, STATUS_ANGGOTA, NO_ANGGOTA, CLUB_TYPE, CLUB_LOCATION, CLUB_CHOICE, HOBBY_DESC, IS_ANDROID) VALUES ('".$name."',
                                '".$email."','".$birthplace."','".$date_birth."','".$gender_radio."','".$bloodtype."','".$nationality."','".$hobby."','".$address."','".$rt. "/" .$rw."','".$province."',
                                '".$city."','".$district."','".$district_word."','".$postcode."','".$ektp."','".$pasFoto."','".$fotoEktp."','1','".$id_anggota."','".$club_type."','".$club_location."','".$club_choice_new."','".$hobby_desc."',".$is_android.")";
            }
    ...
    $queryPost = "UPDATE KTA SET CLUB_TYPE = '$club_type', CLUB_LOCATION = '$club_location', CLUB_CHOICE = '$club_choice_new', STATUS_ANGGOTA = '1' WHERE F_PIN = '$f_pin'";
