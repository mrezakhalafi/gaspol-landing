<?php 
    ...
    // GET TRANSACTION
    $query = $dbconn->prepare("SELECT * FROM KTA LEFT JOIN REGISTRATION_PAYMENT ON KTA.NO_ANGGOTA = REGISTRATION_PAYMENT.REF_ID WHERE REGISTRATION_PAYMENT.REG_TYPE = 2 AND KTA.NO_ANGGOTA IS NOT NULL ORDER BY REGISTRATION_PAYMENT.DATE DESC");
    $query->execute();
...
<body id="page-top">
    ...
    <div class="container-fluid mb-3 header">
        <div class="row">
            <div class="col-12">
                <h5 class="text-dark"><strong>Finance Report KTA Mobility</strong></h2>
            </div>
        </div>
    </div>

                <div id="section-table" class="container-fluid">
...
$(document).ready(function(e) {
    ...
    table = $('#tableKTA').DataTable({
        ...
        $('#tableKTA_filter').html(`
            ...
            <input type="search" class="" placeholder="Search name, KTA no., and status payment" aria-controls="tableKTA">
        `)
...
$("#province").change(function() {
    ...
    xmlHttp.open("post", "logics/finance_kta");
