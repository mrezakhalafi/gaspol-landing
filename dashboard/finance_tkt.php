<?php 
    ...
    // GET TRANSACTION
    $query = $dbconn->prepare("SELECT * FROM TKT LEFT JOIN REGISTRATION_PAYMENT ON TKT.F_PIN = REGISTRATION_PAYMENT.F_PIN WHERE REGISTRATION_PAYMENT.REG_TYPE = 6 AND TKT.CLUB_UID IS NOT NULL GROUP BY TKT.CLUB_UID ORDER BY REGISTRATION_PAYMENT.DATE DESC");
    $query->execute();
...
<body id="page-top">
    ...
    <div class="container-fluid mb-3 header">
        <div class="row">
            <div class="col-12">
                <h5 class="text-dark"><strong>Finance Report TKT IMI Club</strong></h2>
            </div>
        </div>
    </div>
...
$(document).ready(function(e) {
    ...
    table = $('#tableKTA').DataTable({
        ...
        $('#tableKTA_filter').html(`
            ...
            <input type="search" class="" placeholder="Search name, TKT UID., and status payment" aria-controls="tableKTA">
        `)
...
xmlHttp.open("post", "logics/finance_tkt");
