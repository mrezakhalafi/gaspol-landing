...
async function appendComment(formData) {
    ...
    if (!object.hasOwnProperty('reply_id')) {
        ...
        <div class="row mx-0 comments" id="${commentId}">
            ...
            <div class="col-2">
            <img onclick="showProfile('${object.f_pin}')" id="user-thumb-new-${xReply}" alt="Profile Photo" class="rounded-circle my-3" style="height:50px; width:50px; cursor:pointer; object-position: center; background: grey; object-fit: cover;" src="${profpic}">
            </div>
            ...
            <div style="font-weight: 100; color: grey;" class="my-1">${time}&emsp; <span style="font-weight: 300;" data-translate="comment-2" onclick="onReply(true,'user-name-new-${xReply}','${commentId}');">${balas}</span>
            </div>
            </div>
        </div>
        `;
        ...
        <div class="fPin" style="display: none;">${object.f_pin}</div>
        <div class="col-2">
          <img onclick="showProfile('${object.f_pin}')" id="user-thumb-reff-new-${xReffReply}" alt="Profile Photo" class="rounded-circle my-3" style="height:40px; width:40px; cursor:pointer; object-position: center; background: grey; object-fit: cover;" src="${profpic}">
        </div>
        <div class="col-10 text-break">
          <div style="font-weight: bold;" class="mt-3 mb-1 mr-3">
          ...
          <div style="font-weight: 100; color: grey;" class="my-1">${time}&emsp; <span data-translate="comment-2" style="font-weight: 300;" onclick="onReply(true,'user-name-reff-new-${xReffReply}','${commentId}');">${balas}</span>
          </div>
        </div>
      </div>
        `;
