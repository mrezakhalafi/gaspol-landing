...
$('#taa-form').validate({
    ...
    submitHandler: function (form, event) {
        ...
        if (fotoprofile && assname && category && description && adart && address && rt && rw && postcode && province && city && district && subdistrict && bank && banknumber && bankname && president && secretary && clubadmin && finance && club && secclub && thirdclub && fourthclub && fifthclub) {
