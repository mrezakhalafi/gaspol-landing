...
$('#imiclub-form').validate({
    ...
    submitHandler: function(form,event) {
        ...
        if (fotoprofile && clubname && clubtype && kategori && clublocation && description && address && rt && rw && postcode && province && city && district && subdistrict && bank && banknumber && bankname && president && secretary && clubadmin && finance && adart && is_takken == 1 && clubkta){
