...
$('#taa-form').validate({
    ...
    submitHandler: function(form,event) {
        ...
        if (fotoprofile && assname && category && description && adart && certificate && additional && address && rt && rw && postcode && province && city && district && subdistrict && bank && banknumber && bankname && president && secretary && clubadmin && finance && vicepresident && hrd && club && secclub && thirdclub && fourthclub && fifthclub){
