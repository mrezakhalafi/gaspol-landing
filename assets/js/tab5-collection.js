...
modalAddToCart.addEventListener('hidden.bs.modal', function () {
    ...
    // try {
    //     if (checkIOS === false) {
    //         window.webview.messageHandlers.setButtonTheme.postMessage({
    //             param1: '',
    //             param2: 'fb_theme'
    //         });
    //         return;
...
class Addtocart {
    ...
    constructor(async_result) {
        ...
        if (async_result.SHOP_THUMBNAIL != null && async_result.SHOP_THUMBNAIL.trim() != "") {
            profpic = "https://qmera.io/filepalio/image/" + async_result.SHOP_THUMBNAIL;
        } else {
            ...
            <div class="container-fluid">
                <div class="col-12 px-0 mb-3">
                    <div class="addcart-img-container text-center">
                        ...
                        <img style="z-index: 9999" class="addcart-wishlist more" src="../assets/img/icons/More-white.png">
                    </div>
                </div>
            </div>
